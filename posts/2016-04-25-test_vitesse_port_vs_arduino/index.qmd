...
<p class="text-center" style="margin: 40px 0;">
    <img src="./images/test_vitesse_port_vs_arduino-thumb.png" alt="Test de vitesse entre les fonctions de manipulation de ports et les fonctions Arduino Logo" style="width:600px;">
</p>
