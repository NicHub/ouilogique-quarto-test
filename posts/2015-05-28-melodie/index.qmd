...
draft: false
image: ./images/melodie-thumb.png
lang: fr
layout: page
lightbox: auto
...
<p class="text-center" style="margin: 40px 0;">
    <img src="./images/melodie-thumb.png" alt="Mélodies avec un Arduino UNO — Thumb" class="thumb">
</p>


Voici un programme écrit par [Pierre-Yves Rochat, professeur du MOOC sur les µcontrôleurs de l’EPFL](https://www.coursera.org/learn/microcontroleurs){rel="nofollow"} qui montre comment utiliser les timers et les interruptions de l’Arduino UNO (ou du Diduino) pour jouer des mélodies.
