...
draft: false
image: ./images/manipulation_des_ports-thumb.png
lang: fr
layout: page
lightbox: auto
...
<p class="text-center" style="margin: 40px 0;">
    <img src="./images/manipulation_des_ports-thumb.png" alt="La manipulation des entrées-sorties à l’aide des registres de port — Thumb" class="thumb">
</p>
