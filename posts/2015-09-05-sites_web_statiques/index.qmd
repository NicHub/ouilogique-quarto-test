...
draft: false
image: ./images/sites_web_statiques-thumb.png
lang: fr
layout: page
lightbox: auto
...
<p class="text-center" style="margin: 40px 0;">
    <img src="./images/sites_web_statiques-thumb.png" alt="Générateurs de sites web statiques — Thumb" class="thumb">
</p>

> Ouilogique.com était à l’origine généré avec [Jekyll]. Depuis février 2026, il est généré avec [Quarto].
...
-   <https://www.youtube.com/watch?v=jeQCoiZT5gg&feature=em-subs_digest-vrecs>{rel="nofollow"}
