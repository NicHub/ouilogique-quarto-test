...
draft: false
image: ./images/arduino_mega_2560.png
lang: fr
layout: page
lightbox: auto
...
[Fiche technique WROVER](https://www.espressif.com/sites/default/files/documentation/esp32-wrover_datasheet_en.pdf){rel="nofollow"}
...
LoRa DIO2 et DIO1 doivent être connectés à GPIO32 et GPIO33 respectivement.
Source : <https://github.com/LilyGO/TTGO-LORA32/issues/3#issuecomment-363007465>

![Pinout TTGO LoRa][Pinout TTGO LoRa]

[Pinout TTGO LoRa]: ./images/ttgo-lora-002.jpg

## Pinout XIAO nRF52840 avec shield LoRa WIO-SX1262
...
Schéma de la version Sense :
<https://files.seeedstudio.com/wiki/XIAO-BLE/Seeed-Studio-XIAO-nRF52840-Sense-v1.1.pdf>

Page du shield LoRa WIO-SX1262 pour nRF52840 :
<https://www.seeedstudio.com/Wio-SX1262-for-XIAO-p-6379.html>

Schéma du shield LoRa WIO-SX1262 pour nRF52840 :
<https://files.seeedstudio.com/products/113010003/Wio-SX1262%20for%20XIAO%20V1.0.pdf>

<!--
![Pinout XIAO-nRF52840 plus][Pinout XIAO-nRF52840 plus]

[Pinout XIAO-nRF52840 plus]: ./images/XIAO-nRF52840.jpg

![Pinout XIAO-nRF52840][Pinout XIAO-nRF52840]

[Pinout XIAO-nRF52840]: ./images/XIAO-nRF52840-2.jpg

![Pinout XIAO-nRF52840 back][Pinout XIAO-nRF52840 back]

[Pinout XIAO-nRF52840 back]: ./images/XIAO-nRF52840-3.jpg
 -->

![Pinout XIAO-nRF52840-4][Pinout XIAO-nRF52840-4]

[Pinout XIAO-nRF52840-4]: ./images/XIAO-nRF52840-4.png

![Pinout XIAO-nRF52840-5][Pinout XIAO-nRF52840-5]

[Pinout XIAO-nRF52840-5]: ./images/XIAO-nRF52840-5.png

![Pinout XIAO-nRF52840-6][Pinout XIAO-nRF52840-6]

[Pinout XIAO-nRF52840-6]: ./images/XIAO-nRF52840-6.png

## Pinout XIAO ESP32S3 Plus

Page du produit : <https://www.seeedstudio.com/Seeed-Studio-XIAO-ESP32S3-Plus-p-6361.html>

> Note : Comparé à l’ESP32S3, l’ESP32S3 Plus a 9 GPIO supplémentaires disponibles sur les broches semi-circulaires.

Schéma de l’ESP32S3 : <https://files.seeedstudio.com/wiki/SeeedStudio-XIAO-ESP32S3/res/XIAO_ESP32S3_SCH_v1.1.pdf>

![XIAO-ESP32S3-Plus][XIAO-ESP32S3-Plus]

[XIAO-ESP32S3-Plus]: ./images/XIAO-ESP32S3-Plus.jpg

## Pinout XIAO WIO-SX1262 pour ESP32S3

Schéma du shield LoRa WIO-SX1262 pour ESP32S3 : <https://files.seeedstudio.com/products/SenseCAP/Wio_SX1262/Schematic_Diagram_Wio-SX1262_for_XIAO.pdf>

![XIAO-WIO-SX1262][XIAO-WIO-SX1262]

[XIAO-WIO-SX1262]: ./images/Z4T-WIO-SX1262.webp

## Pinout Heltec V3

![heltec-v3-001][heltec-v3-001]

[heltec-v3-001]: ./images/heltec-v3-001.jpg

![heltec-v3-002][heltec-v3-002]

[heltec-v3-002]: ./images/heltec-v3-002.jpg
