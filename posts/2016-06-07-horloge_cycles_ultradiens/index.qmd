---
aliases:
- /horloge_cycles_ultradiens
author: Nico
categories: []
date: 2016-06-07 10:13:00+02:00
draft: false
image: ./images/horloge_cycles_ultradiens_002_lowres.jpg
lang: fr
layout: page
lightbox: auto
...
![Horloge à cycles ultradiens — Arduino Nano][img_1]

[img_1]: ./images/horloge_cycles_ultradiens_002_lowres.jpg
...
![Horloge à cycles ultradiens — Arduino Nano][img_2]

[img_2]: ./images/horloge_cycles_ultradiens_004_lowres.jpg
...
![Horloge à cycles ultradiens — ESP8266][img_3]

[img_3]: ./images/horloge_cycles_ultradiens_003_lowres.jpg

### Code source

-   <https://github.com/NicHub/ouilogique-ESP8266-Arduino/tree/master/horloge-cycles-ultradiens-esp8266>

## À voir ou lire aussi

-   [Présentation du 03.06.2022, « gestion d’interrupteurs, anti-rebonds & Cie, utilisation de touches click, double click, clik court, long etc. »,  Claude Balmer][balmer-debounce]

[balmer-debounce]: ./docs/TouchesCB.pdf

-   [Texas Instrument — Debounce a Switch]

[Texas Instrument — Debounce a Switch]: https://www.youtube.com/watch?v=e1-kc04jSE4

-   [What is Switch Bounce and How to Debounce – ATM | Digi-Key Electronics]

[What is Switch Bounce and How to Debounce – ATM | Digi-Key Electronics]: https://www.youtube.com/watch?v=IvU8m_30iK0
