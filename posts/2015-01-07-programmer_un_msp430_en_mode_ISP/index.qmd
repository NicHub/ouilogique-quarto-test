...
- /programmer_un_msp430_en_mode_ISP
author: Nico
categories:
- MSP430
- ISP
...
Lors du [quatrième MOOC sur les µcontrôleurs de l’EPFL](https://www.coursera.org/learn/microcontroleurs){rel="nofollow"}, Pierre-Yves Rochat nous a présenté comment utiliser une carte Launchpad pour programmer un MSP430 sur un breadboard.
...
[Le document original au format PDF](./docs/ExperiencesAvecLaunchpad.pdf)

Voilà le proto sur breadboard :

![ouilogique.com][img_1]

[img_1]: ./images/P1030387.JPG

Voilà le résultat final :

![ouilogique.com][img_2]

[img_2]: ./images/blink_noel_v2_021.jpg

![ouilogique.com][i3]

[i3]: ./images/adafruit_perma-proto_pt_129.jpg

![ouilogique.com][i4]

[i4]: ./images/adafruit_perma-proto_pt_131-1.jpg

## Leçons apprises

-   Programmer un MSP sur breadboard (un MSP430G2231 dans cette application).
-   Utiliser une découpeuse laser.
-   [Les plaques à souder Perma-Proto d’Adafruit](https://blog.adafruit.com/2011/11/18/adafruit-perma-proto-half-sized-breadboard-pcb-3-pack/){rel="nofollow"} sont très pratiques.
...
![ouilogique.com][img_903]

[img_903]: ./images/blink_noel_v2_018.jpg

![ouilogique.com][img_904]

[img_904]: ./images/blink_noel_v2_001.jpg

![ouilogique.com][img_905]

[img_905]: ./images/blink_noel_v2_006.jpg

![ouilogique.com][img_906]

[img_906]: ./images/blink_noel_v2_008.jpg
