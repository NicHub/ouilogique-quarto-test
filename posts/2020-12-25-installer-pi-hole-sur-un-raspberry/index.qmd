...
draft: false
image: ./images/Vortex_with_Wordmark-thumb.png
lang: fr
layout: page
lightbox: auto
...
<p class="text-center" style="margin: 40px 0;">
    <img src="./images/Vortex_with_Wordmark-thumb.png" alt="Pi Hole — Thumb" class="thumb">
</p>
...
-   [Matériel compatible](https://docs.pi-hole.net/main/prerequisites/#hardware)
...
-   Flasher Raspberry Pi OS sur une carte SD.
    ([Voir la procédure détaillée.](../2023-03-09-installer-raspberry-pi-os-sur-raspberry-pi-sans-clavier-ni-souris-ni-ecran/))
...
-   Copier les [URL des listes de blocage (Adlists)](./docs/pi-hole-adlists.txt).
...
-   Copier les [URL des faux positifs (Whitelist)](./docs/pi-hole-whitelist.txt).
